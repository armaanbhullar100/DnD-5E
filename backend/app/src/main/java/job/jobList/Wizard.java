...
public class Wizard extends Job {
    ...
    public Wizard(String name, int hitDice, ArrayList<String> itemProficiencies, ArrayList<String> savingThrowProficiencies, 
    ...
    public int getWizardSpellsKnown() {
        return getExtraMechanics().getWizardSpellsKnown(getLevel()-1);
    }
